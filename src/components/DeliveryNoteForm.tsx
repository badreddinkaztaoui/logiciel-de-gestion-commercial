...
import { formatDate, generateDocumentNumber } from '../utils/formatters';
    ...
    const loadData = async () => {
      try {
        ...
        if (editingNote) {
          ...
          setEstimatedDeliveryDate(editingNote.estimatedDeliveryDate || '');
          ...
          if (editingNote.invoiceId) {
            const invoice = invoices.find(i => i.id === editingNote.invoiceId);
